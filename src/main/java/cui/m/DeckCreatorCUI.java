...
import cui.functions.DeckCreator;
...
public class DeckCreatorCUI {
    ...
    public static void editDeck(DeckCreator c, Scanner s) {
        ...
        while (loop == true) {
            ...
            switch (options) {
                ...
                {
                    try {
                        MtgCardManager.allDecks.saveDeck(deck);
                        loop = false;
    ...
    public static void StartCUI(Deck deck ,Scanner s){
        DeckCreator dc = new DeckCreator(deck, MtgCardManager.database);
        DeckCreatorCUI.editDeck(dc, s);
    }
        public static void startCUI(String name, Scanner s) {
        DeckCreator dc = new DeckCreator(name, MtgCardManager.database);
        DeckCreatorCUI.editDeck(dc, s);}
